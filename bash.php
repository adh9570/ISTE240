...
?>	
        <main>
            ...
            <div id="bashintro">
                <h2>Bash Shell Introduction</h2>
                <hr>
                <p> 
                    Now that you've gotten your Linux all set up and running,
                    A black window called a Terminal should appear on
                    your screen. containing a blinking cursor following the words:
                    <strong>root@localhost:~#</strong>
                    <img src="bashshell.jpg" alt="Bash Shell image">
                </p>
            </div>
            
            <div id="bashsections">
                <h2>What Does The Bash Shell Show?</h2>
                <hr>
                    <p>
                        ...
                        <li>
                            ...
                            <p>
                                ...
                                root will instead display <strong>\$</strong>.
                            </p>    
            ...
            <div id="bashcommands">
                ...
                <p>
                    ...
                    <strong>cd (directory name)</strong>
                    <div id="bashpart">
                        <img src="bashshell.jpg" alt="Bash Shell image">
                    </div>
...
<<<<<<< HEAD
<<<<<<< HEAD
                    <strong>mkdir (new directory name)</strong>
=======
<<<<<<< HEAD
                    <strong>mkdir (new directory name) rmdir (directory name)</strong>
=======
                    <strong>mkdir (new directory name)</strong>
...
=======
<<<<<<< HEAD
                    In parallel, <strong>rmdir</strong> is the command used to delete a directory. 
=======
                     In parallel, <strong>rmdir</strong> is the command used to delete a directory. 
>>>>>>> master
                </p>
                ...
                <p>
                    <strong>rm (directory / file name) / rm -r (directory name)</strong>
                    <div id="bashpart">
                        <img src="bashshell.jpg" alt="Bash Shell image">
                    </div>
                    ...
                    the files contained inside, <strong>rm (directory name)</strong>. However, if you want to just delete the directory without wiping the files
                    as well, <strong>rm -r (directory name)</strong> will delete the directory but move all the files into whichever directory you are currently in.
                    
                </p>

                <p>
                    <strong>mv (filename) (new name)</strong>
                    <div id="bashpart">
                        <img src="bashshell.jpg" alt="Bash Shell image">
                    </div>
                ...
                <p>
                    ...
                    the command that you don't understand. For example, typing <strong>man cd</strong> will show the manual pages for the cd command. Or, you can type
                    the command name followed by <strong>-help</strong> to see the same manual pages.
                ...
                <p>
                    ...
                    "amazing", you type <strong>locate -i amazing</strong>. If you know more than one word, just add asterisks between the words. That would look like
                    <strong>locate -i *amazing*food*</strong>
